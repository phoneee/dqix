...
def test_whois_probe_valid_domain() -> None:
...
def test_whois_probe_invalid_domain() -> None:
...
def test_whois_probe_malformed_domain() -> None:
...
def test_whois_probe_empty_domain() -> None:
...
def test_whois_probe_none_domain() -> None:
